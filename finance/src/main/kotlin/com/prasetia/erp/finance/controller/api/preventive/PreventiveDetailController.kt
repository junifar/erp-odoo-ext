package com.prasetia.erp.finance.controller.api.preventive

import com.prasetia.erp.finance.model.preventive.PreventiveSaleOrder
import com.prasetia.erp.finance.model.preventive.PreventiveSaleOrderInvoice
import com.prasetia.erp.finance.pojo.preventive.PreventiveBudget
import com.prasetia.erp.finance.pojo.preventive.PreventiveBudgetArea
import com.prasetia.erp.finance.pojo.preventive.PreventiveCustomerDetailHeader
import com.prasetia.erp.finance.pojo.preventive.PreventiveInvoice
import com.prasetia.erp.finance.pojo.preventive.PreventiveRealisasiBudget
import com.prasetia.erp.finance.pojo.preventive.PreventiveRealisasiBudgetArea
import com.prasetia.erp.finance.repository.preventive.PreventiveBudgetRealisasiRepository
import com.prasetia.erp.finance.repository.preventive.PreventiveBudgetRepository
import com.prasetia.erp.finance.repository.preventive.PreventiveCustomerDetailRepository
import com.prasetia.erp.finance.repository.preventive.PreventiveInvoiceRepository
import com.prasetia.erp.finance.repository.preventive.PreventiveSaleOrderInvoiceRepository
import com.prasetia.erp.finance.repository.preventive.PreventiveSaleOrderRepository
...
class PreventiveDetailController{
    ...
    fun getPreventiveBudgetRealisasi(name: String, data:Iterable<com.prasetia.erp.finance.model.preventive.PreventiveRealisasiBudget>, bulan: Long): Long{
        var value:Long = 0
        data.forEach {
            item->
    ...
    fun getPreventivePOInvoice(clientOrderRef: String, data:Iterable<PreventiveSaleOrderInvoice>):MutableList<com.prasetia.erp.finance.pojo.preventive.PreventiveSaleOrderInvoice>{
        val preventiveSaleOrderInvoice:MutableList<com.prasetia.erp.finance.pojo.preventive.PreventiveSaleOrderInvoice> = mutableListOf()
        data.forEach {
            item->
            if(item.client_order_ref == clientOrderRef){
                ...
                if(!found){
                    ...
                    preventiveSaleOrderInvoice.add(com.prasetia.erp.finance.pojo.preventive.PreventiveSaleOrderInvoice(item.id, item.client_order_ref, item.state, i, ii, iii,
    ...
    fun getPreventiveSaleOrder(customer_id: Int, tahun: String, area_id: String, data:Iterable<PreventiveSaleOrder>, dataSaleOrder:Iterable<PreventiveSaleOrderInvoice>): MutableList<com.prasetia.erp.finance.pojo.preventive.PreventiveSaleOrder>{
        val preventiveSaleOrder:MutableList<com.prasetia.erp.finance.pojo.preventive.PreventiveSaleOrder> = mutableListOf()
        data.forEach {
            item->
            if((item.tahun.toString() == tahun) and (item.customer_id == customer_id.toLong()) and (item.area_id.toString() == area_id)){
                ...
                if (!found)
                {
                    ...
                    preventiveSaleOrder.add(com.prasetia.erp.finance.pojo.preventive.PreventiveSaleOrder(
                            item.id,
    ...
    fun getPreventiveSaleOrderNilaiInvoice(customer_id: Int, tahun: String, area_id: String, clientOrderRef: String, bulan: Long, data:Iterable<com.prasetia.erp.finance.model.preventive.PreventiveInvoice>): Long{
        var nilai_po:Long = 0
        data.forEach {
            item->
            if((item.tahun.toString() == tahun) and
    ...
    fun getPreventiveInvoice(customer_id: Int, tahun: String, area_id: String, data:Iterable<com.prasetia.erp.finance.model.preventive.PreventiveInvoice>): MutableList<PreventiveInvoice>{
    ...
    fun getPreventiveNilaiBudget(customer_id: Int, tahun: String, area_id: String, name: String, bulan: Long, data:Iterable<com.prasetia.erp.finance.model.preventive.PreventiveBudget>): Long{
    ...
    fun getPreventiveBudget(customer_id: Int, tahun: String, area_id: String, sub_area: String?,
                            data:Iterable<com.prasetia.erp.finance.model.preventive.PreventiveBudget>,
                            dataRealisasiBudget: Iterable<com.prasetia.erp.finance.model.preventive.PreventiveRealisasiBudget>):MutableList<PreventiveBudget>{
    ...
    fun getPreventiveBudgetWithRealisasiBudget(customer_id: Int, tahun: String, area_id: String, sub_area: String?,
                                               ...
                                               data:Iterable<com.prasetia.erp.finance.model.preventive.PreventiveRealisasiBudget>): MutableList<PreventiveRealisasiBudget> {
    ...
    fun getPreventiveBudgetArea(customer_id: Int, tahun: String, area_id: String,
                                data:Iterable<com.prasetia.erp.finance.model.preventive.PreventiveBudget>,
                                dataRealisasiBudget: Iterable<com.prasetia.erp.finance.model.preventive.PreventiveRealisasiBudget>):MutableList<PreventiveBudgetArea>{
    ...
    fun getPreventiveNilaiRealisasiBudget(customer_id: Int, tahun: String, area_id: String, name: String, bulan: Long, data:Iterable<com.prasetia.erp.finance.model.preventive.PreventiveRealisasiBudget>): Long{
        var nilai_budget:Long = 0
        data.forEach {
            item->
            if((item.tahun.toString() == tahun) and
    ...
    fun getPreventiveRealisasiBudget(customer_id: Int, tahun: String, area_id: String, sub_area: String?, data:Iterable<com.prasetia.erp.finance.model.preventive.PreventiveRealisasiBudget>):MutableList<PreventiveRealisasiBudget>{
        val preventiveRealisasiBudget:MutableList<PreventiveRealisasiBudget> = mutableListOf()
        val filterValue = when(area_id){
            "null" -> data.filter { it.customer_id == customer_id.toLong() }
                    .filter { it.tahun == tahun.toLong() }
    ...
    fun getPreventiveRealisasiBudgetArea(customer_id: Int, tahun: String, area_id: String, data:Iterable<com.prasetia.erp.finance.model.preventive.PreventiveRealisasiBudget>): MutableList<PreventiveRealisasiBudgetArea>{
