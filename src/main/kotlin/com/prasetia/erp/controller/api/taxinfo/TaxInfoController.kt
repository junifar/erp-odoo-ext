package com.prasetia.erp.controller.api.taxinfo

import com.prasetia.erp.pojo.taxinfo.TaxInvoiceData
import com.prasetia.erp.pojo.taxinfo.TaxInvoicePeriodeData
import com.prasetia.erp.repository.taxinfo.TaxInvoicePeriodeRepository
import com.prasetia.erp.repository.taxinfo.TaxInvoiceRepository
    ...
    fun getTaxInvoice():MutableList<TaxInvoiceData>{
        ...
        data.forEach {
            taxInvoiceData.add(TaxInvoiceData(it.id, it.invoice_id, it.nomor_faktur, it.invoice_no, it.customer_name,
                    it.state, it.tax_amount, it.name, it.total, it.subtotal_original, it.subtotal, it.tanggal_pembayaran,
