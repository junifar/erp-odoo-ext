package com.prasetia.erp.repository.taxinfo

import com.prasetia.erp.model.taxinfo.TaxInvoice
import com.prasetia.erp.model.taxinfo.TaxInvoicePeriode
...
interface TaxInvoicePeriodeRepository:CrudRepository<TaxInvoicePeriode, Long>{
    companion object {
        const val QUERY = """
                            SELECT
                                ROW_NUMBER() OVER (ORDER BY EXTRACT(YEAR FROM "public".account_invoice.date_invoice)) AS id,
                                EXTRACT(YEAR FROM "public".account_invoice.date_invoice) AS YEAR,
